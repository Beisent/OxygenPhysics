...
{
    class ComputeInertia
    {
    public:
        static real computeCircle(const real &mass, const real &radius)
        {
            return mass * radius * radius / 2;
        }
        static real computePolygon(const real &mass, const std::vector<Vec2> &vertices)
        {
        ...
        static real computeBox(const real &mass, const real &size)
        {
